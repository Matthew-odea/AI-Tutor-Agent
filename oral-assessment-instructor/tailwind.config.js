...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Backed by CSS vars in src/index.css so `.dark` re-themes everything.
        // The `rgb(var(--x) / <alpha-value>)` form is required: with a bare
        // `var(--x)`, alpha modifiers like `bg-ink/5` silently emit no CSS.
        ...
        // Legacy alias so any leftover `primary-*` class still renders teal; use `accent`.
        primary: {
          50: '#E6F2EF',
          100: '#CCE5DF',
          200: '#99CCBF',
